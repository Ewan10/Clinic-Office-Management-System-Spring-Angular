...
public class PatientControllerTest {
        ...
        void shouldReturnAllPatients() throws Exception {
                List<PatientBasicDto> patients = List.of(
                                new PatientBasicDto(1, "Sergio", "Ramos", "123-456-7890", "sergio@mail.es", 123456789L,
                                                35),
                                new PatientBasicDto(2, "Andres", "Iniesta", "987-654-3210", "andres@mail.es",
                                                987654321L, 34));
        ...
        void shouldDeletePatientSuccessfully() throws Exception {
                ...
                mockMvc.perform(delete("/patients/{id}", id))
                                ...
                                .andExpect(jsonPath("$.message")
                                                .value("Patient with ID " + id + " deleted successfully"));
        }
